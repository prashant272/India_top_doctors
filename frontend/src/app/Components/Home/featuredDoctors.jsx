...
const PLAN_ORDER = { 'premium plan': 1, 'standard plan': 2 }
...
export default function FeaturedDoctors() {
  ...
  const doctors = useMemo(() => {
    return allDoctors
      ...
      .sort((a, b) => {
        const aName = (a.currentPlan?.name || '').toLowerCase().trim()
        const bName = (b.currentPlan?.name || '').toLowerCase().trim()
        return (PLAN_ORDER[aName] ?? 99) - (PLAN_ORDER[bName] ?? 99)
      })
  }, [allDoctors])
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-600 text-lg max-w-3xl mx-auto">
            Hand-picked premium and standard plan doctors ready to serve you.
          </p>
        </div>
